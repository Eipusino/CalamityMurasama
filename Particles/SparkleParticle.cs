...
namespace CalMurasama.Particles
{
    public class SparkleParticle : Particle
    {
        public override string Texture => "CalMurasama/Particles/Sparkle2";
        ...
        public override void CustomDraw(SpriteBatch spriteBatch)
        {
            ...
            Texture2D bloomTexture = ModContent.Request<Texture2D>("CalMurasama/Particles/BloomCircle").Value;
